...
export class SortableSpecService {
  ...
  private initialTree: CardTree = [
    { id: 1, title: "To Do", cards: [
      {listId: 1, id: 10, title: "Create a Kaban Board"},
      {listId: 1, id: 20, title: "Create fake tasks"},
    ]},
    { id: 2, title: "Doing", cards: [
      {listId: 2, id: 30, title: "Find Drag&Drop libraries"},
    ]},
    { id: 3, title: "Done", cards: [
      {listId: 3, id: 40, title: "Learn what drag & drop is"},
    ]}
  ];
